...
import { Sparkles, Brain, FileSearch, TrendingUp } from "lucide-react";
      ...
      <CardContent className="py-16">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="space-y-4 text-center">
            <h3 className="text-xl font-semibold">{t('timeline.loadingTitle')}</h3>
          ...
          <p className="text-sm text-muted-foreground">{t('timeline.loadingHint')}</p>
        </div>
      </CardContent>
    </Card>
  );
